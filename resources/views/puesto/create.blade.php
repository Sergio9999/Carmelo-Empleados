    ...
    <div class="grid-form col-12 col-md-8 col-sm-12 col-lg-8 pb-5 px-5 rounded rounded-lg shadow-lg d-flex flex-column aling-items-center">
      ...
      <form method="POST" action="{{url('puesto')}}">
        ...
        <div class="form-group d-flex flex-column mx-auto"
          ...
          <input type="number" name="minimo"  value="{{old('minimo')}}" id="min" min="1" max="999999.99" step="0.01" class="form-control">
        </div>

        <div class="form-group d-flex flex-column mx-auto">
          <label for="max">maximo</label>
          <input type="number" name="maximo"  value="{{old('maximo')}}" id="max" min="1" max="999999.99" step="0.01" class="form-control">
        </div>
