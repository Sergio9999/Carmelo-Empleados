    ...
    <div class="grid-form col-12 col-md-8 col-sm-12 col-lg-8 pb-5 px-5 rounded rounded-lg shadow-lg d-flex flex-column aling-items-center">
      ...
      <form method="Post" action="{{url('empleado/'.$empleado->id)}}">
       ...
       <div class="form-group d-flex flex-column mx-auto">
          ...
          <input type="text" value="{{$empleado->nombre}}" name="nombre" id="name" class="form-control">
        </div>
        <div class="form-group d-flex flex-column mx-auto">
          <label for="apellido">Apellido del empleado</label>
          <input type="text" value="{{$empleado->apellido}}" name="apellido" id="apellido" class="form-control">
        </div>
        
        <div class="form-group d-flex flex-column mx-auto">
          <label for="email">Email del empleado</label>
          <input type="email" value="{{$empleado->email}}" name="email" id="email" class="form-control">
        </div>
        
         <div class="form-group d-flex flex-column mx-auto">
          <label for="telefono">Telefono del empleado</label>
          <input type="text" value="{{$empleado->telefono}}" name="telefono" id="telefono" class="form-control">
        </div>
        
         <div class="form-group d-flex flex-column mx-auto">
          <label for="fecha_contrato">Fecha de contrato</label>
          <input type="date" value="{{$empleado->fecha_contrato}}" name="fecha_contrato" id="fecha_contrato" class="form-control">
        </div>
